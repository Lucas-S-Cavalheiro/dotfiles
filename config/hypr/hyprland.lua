...
hl.on("hyprland.start", function () 
  hl.exec_cmd("waybar & awww-daemon & hyprpolkitagent")
end)
...
hl.bind("CTRL + SHIFT + backslash", hl.dsp.exec_cmd(screenshot))
...
-- Regras de janela para a Steam no Hyprland (Sintaxe Lua)
rules = {
  {
    rule = "float",
    match = {
      class = "^(steam)$",
      title = { "^(Friends List|Settings|.*- Properties|News|Screenshot Uploader)$" },
    },
  },
  {
    rule = "center",
...
-- Regras para o KeePassXC no Hyprland (Sintaxe Lua)
rules = {
  {
    rule = "float",
    match = {
      class = "^(org.keepassxc.KeePassXC)$",
      title = { "^(Unlock.*|KeePassXC - Browser Access Request)$" },
    },
  },
  {
    rule = "center",
